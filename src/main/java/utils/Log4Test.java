...
public class Log4Test {
    ...
    private static final String RESULT_LOG = "RESULT: \"%s\"";
    ...
    {
        LOGGER.info(String.format(RESULT_LOG, message));
        Reporter.log(String.format(RESULT_LOG, message));
        return String.format(RESULT_LOG, message);
    }
